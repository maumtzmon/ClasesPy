...
#	image='image.fz'
	...
	string='RUNID'				# Variable to be the x axis, as shown in the header of the image
...
#				offset = 0			# Offset to plot
				...
				bin_heights, bin_borders, _ = axs_all[figctr].hist(data[mask].flatten(), range=[offset-1000, offset+1000], bins=200, histtype='step', label=hlabel)	# Plot histogram
