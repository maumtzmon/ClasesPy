...
#				var.append(np.median(data[mask]))	# Median
		...
		#imgDict.setdefault('img'+stringval,{'stdv':{'Module 1':var[0],'Module 2':var[1],'Module 3':var[2], 'Module 4':var[3]},
		#									 'noise':{'Module 1':var_fit[0],'Module 2': var_fit[1],'Module 3': var_fit[2],'Module 4': var_fit[3]}})
